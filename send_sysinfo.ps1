...
$array = $Object
$array | Export-Csv -Path C:\Users\jorge\Desktop\test.csv -NoTypeInformation # Aqui se genera archivo csv
#
#### Para Envio de correo
#
$Username = "soy.yo@correo.com"; # Aqui va tu cuenta de gmail
$Password = "************";      # Aqui va tu password de aplicación
$path = "C:\Users\jorge\Desktop\test.csv";       # Aqui va la ruta de el archivo csv generado previamente

function Send-ToEmail([string]$email, [string]$attachmentpath){

    $message = new-object Net.Mail.MailMessage;
    $message.From = "soy.yo@correo.com"; # Aqui va tu cuenta de gmail.
...
Send-ToEmail  -email "tambiensoy.yo@correo.com" -attachmentpath $path; # En email pones el destinatario